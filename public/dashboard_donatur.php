    ...
    <aside class="sidebar">
        <div class="sidebar-header">
            <a href="../index.php" class="sidebar-logo">
                ...
                <span>Donasi Masjid</span>
            </a>
        </div>
        
        <nav class="sidebar-nav">
            <a href="dashboard_donatur.php" class="nav-item active">
            ...
            <a href="form_donasi.php" class="nav-item">
                <span class="nav-icon">💰</span>
                <span>Donasi</span>
            </a>
            <a href="top_campaign.php" class="nav-item">
                <span class="nav-icon">🏆</span>
        ...
        <div class="sidebar-footer">
            <a href="../controller/logout_donaturController.php" class="nav-item logout">
                <span class="nav-icon">🚪</span>
                <span>Logout</span>
            </a>
        </div>
    ...
    <div class="main-wrapper">
        ...
        <main class="main-content">
            <div class="page-header">
                ...
                <p>Selamat datang kembali, Donatur! Laporan penggunaan dana akan tampil di bawah jika admin sudah mengunggahnya.</p>
            </div>
                    ...
                    <tbody>
                        ...
                        if (empty($riwayat_donasi)) {
                            ...
                            foreach ($riwayat_donasi as $donasi) {
                                ...
                                echo "<a href='../controller/hapus_donasiController.php?id_donasi=" . urlencode($donasi['ID_DONASI'] ?? '') . "' class='btn-laporan' style='background:#dc3545;margin-right:5px;' onclick='return confirm(\"Apakah Anda yakin ingin menghapus donasi ini?\");'>Hapus</a>";
                                echo "</td>";
                                echo "</tr>";
                            }
                        }
                ...
                <div id="reportsList">
                    ...
                    if (empty($laporan_list)) {
                        ...
                        foreach ($laporan_list as $laporan) {
                            ...
                            $deskripsi = htmlspecialchars($isi ?? '');
