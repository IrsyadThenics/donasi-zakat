...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "DONASI"."SEQ_CAMPAIGN"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 81 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_DONASI
--------------------------------------------------------

   CREATE SEQUENCE  "DONASI"."SEQ_DONASI"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "DONASI"."SEQ_LAPORAN"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "DONASI"."CAMPAIGN" 
   (	"ID_CAMPAIGN" NUMBER, 
	...
	"TARGET_DANA" NUMBER(18,2), 
	"DANA_TERKUMPUL" NUMBER(18,2) DEFAULT 0, 
	"TANGGAL_MULAI" DATE, 
...
SET DEFINE OFF;
Insert into DONASI.CAMPAIGN (ID_CAMPAIGN,ID_PENERIMA,JUDUL_CAMPAIGN,TARGET_DANA,DANA_TERKUMPUL,TANGGAL_MULAI,TANGGAL_DEADLINE,STATUS,CREATED_AT,UPDATED_AT,POSTER,DESKRIPSI) values ('21','1','apaaa','1400000000','21000000',to_date('13-11-2025','DD-MM-RRRR'),to_date('13-12-2025','DD-MM-RRRR'),'Aktif',to_date('13-11-2025','DD-MM-RRRR'),to_date('19-11-2025','DD-MM-RRRR'),null,null);
Insert into DONASI.CAMPAIGN (ID_CAMPAIGN,ID_PENERIMA,JUDUL_CAMPAIGN,TARGET_DANA,DANA_TERKUMPUL,TANGGAL_MULAI,TANGGAL_DEADLINE,STATUS,CREATED_AT,UPDATED_AT,POSTER,DESKRIPSI) values ('1','1','donasi untuk gempa bumi','1400000','14000000',to_date('08-11-2025','DD-MM-RRRR'),to_date('08-12-2025','DD-MM-RRRR'),'Aktif',to_date('08-11-2025','DD-MM-RRRR'),to_date('16-11-2025','DD-MM-RRRR'),null,null);
Insert into DONASI.CAMPAIGN (ID_CAMPAIGN,ID_PENERIMA,JUDUL_CAMPAIGN,TARGET_DANA,DANA_TERKUMPUL,TANGGAL_MULAI,TANGGAL_DEADLINE,STATUS,CREATED_AT,UPDATED_AT,POSTER,DESKRIPSI) values ('63','23','zakat','140000000','0',to_date('19-11-2025','DD-MM-RRRR'),to_date('19-12-2025','DD-MM-RRRR'),'Aktif',to_date('19-11-2025','DD-MM-RRRR'),to_date('21-11-2025','DD-MM-RRRR'),null,'untuk keluarga kurang mampu');
REM INSERTING into DONASI.DONASI
SET DEFINE OFF;
Insert into DONASI.DONASI (ID_DONASI,ID_DONATUR,ID_CAMPAIGN,JUMLAH_DONASI,IS_ANONIM,TANGGAL_DONASI,CREATED_AT,UPDATED_AT,METODE,PESAN) values ('22','26','63','500000','0',to_date('20-11-2025','DD-MM-RRRR'),to_date('20-11-2025','DD-MM-RRRR'),to_date('20-11-2025','DD-MM-RRRR'),'Transfer Bank','semoga lancar');
Insert into DONASI.DONASI (ID_DONASI,ID_DONATUR,ID_CAMPAIGN,JUMLAH_DONASI,IS_ANONIM,TANGGAL_DONASI,CREATED_AT,UPDATED_AT,METODE,PESAN) values ('24','3','63','70000000','0',to_date('20-11-2025','DD-MM-RRRR'),to_date('20-11-2025','DD-MM-RRRR'),to_date('20-11-2025','DD-MM-RRRR'),'Tunai','gatau');
Insert into DONASI.DONASI (ID_DONASI,ID_DONATUR,ID_CAMPAIGN,JUMLAH_DONASI,IS_ANONIM,TANGGAL_DONASI,CREATED_AT,UPDATED_AT,METODE,PESAN) values ('27','26','63','700000','0',to_date('21-11-2025','DD-MM-RRRR'),to_date('21-11-2025','DD-MM-RRRR'),to_date('21-11-2025','DD-MM-RRRR'),'E-Wallet',null);
...
Insert into DONASI.DONASI (ID_DONASI,ID_DONATUR,ID_CAMPAIGN,JUMLAH_DONASI,IS_ANONIM,TANGGAL_DONASI,CREATED_AT,UPDATED_AT,METODE,PESAN) values ('25','26','63','7000000','0',to_date('20-11-2025','DD-MM-RRRR'),to_date('20-11-2025','DD-MM-RRRR'),to_date('21-11-2025','DD-MM-RRRR'),'E-Wallet',null);
REM INSERTING into DONASI.DONATUR
SET DEFINE OFF;
Insert into DONASI.DONATUR (ID_DONATUR,NAMA_DONATUR,EMAIL,NOMOR_TELEPON,TANGGAL_TERDAFTAR,CREATED_AT,UPDATED_AT,PASSWORD_HASH,IS_ACTIVE) values ('26','ces','ibad20@gmail.com',null,to_date('11-11-2025','DD-MM-RRRR'),to_date('11-11-2025','DD-MM-RRRR'),to_date('19-11-2025','DD-MM-RRRR'),'$2y$10$IYF8JM/fLuJVcX1MVLXqSuxIqgoNN.7UBh7cAaORrEDSBL9VnlRry','1');
Insert into DONASI.DONATUR (ID_DONATUR,NAMA_DONATUR,EMAIL,NOMOR_TELEPON,TANGGAL_TERDAFTAR,CREATED_AT,UPDATED_AT,PASSWORD_HASH,IS_ACTIVE) values ('41','Donatur Anonim','anonim@donasi.local',null,to_date('16-11-2025','DD-MM-RRRR'),to_date('16-11-2025','DD-MM-RRRR'),to_date('16-11-2025','DD-MM-RRRR'),null,'1');
Insert into DONASI.DONATUR (ID_DONATUR,NAMA_DONATUR,EMAIL,NOMOR_TELEPON,TANGGAL_TERDAFTAR,CREATED_AT,UPDATED_AT,PASSWORD_HASH,IS_ACTIVE) values ('23','poco','poco@gmail.com',null,to_date('11-11-2025','DD-MM-RRRR'),to_date('11-11-2025','DD-MM-RRRR'),to_date('20-11-2025','DD-MM-RRRR'),'$2y$10$9a8zxpUxDdhj8I4g3YSZquATbObhP126AaIIfDepCONsWiIr17Lri    ','0');
Insert into DONASI.DONATUR (ID_DONATUR,NAMA_DONATUR,EMAIL,NOMOR_TELEPON,TANGGAL_TERDAFTAR,CREATED_AT,UPDATED_AT,PASSWORD_HASH,IS_ACTIVE) values ('24','admin21','admin21@gmail.com',null,to_date('11-11-2025','DD-MM-RRRR'),to_date('11-11-2025','DD-MM-RRRR'),to_date('20-11-2025','DD-MM-RRRR'),'$2y$10$k4n/tpGQCpEu7lg5m8gKY.p2qIo1ZopsbnRU1a2eGAPCYhmdwPROW    ','0');
Insert into DONASI.DONATUR (ID_DONATUR,NAMA_DONATUR,EMAIL,NOMOR_TELEPON,TANGGAL_TERDAFTAR,CREATED_AT,UPDATED_AT,PASSWORD_HASH,IS_ACTIVE) values ('3','kensato','kensato@gmail.com','122233334444',to_date('08-11-2025','DD-MM-RRRR'),to_date('08-11-2025','DD-MM-RRRR'),to_date('08-11-2025','DD-MM-RRRR'),'52284d0a4d012a8c47fb008f2f099662641798b2deca757753941e83ce086558','1');
Insert into DONASI.DONATUR (ID_DONATUR,NAMA_DONATUR,EMAIL,NOMOR_TELEPON,TANGGAL_TERDAFTAR,CREATED_AT,UPDATED_AT,PASSWORD_HASH,IS_ACTIVE) values ('21','Irsyadul Ibad','kipas@gmail.com',null,to_date('11-11-2025','DD-MM-RRRR'),to_date('11-11-2025','DD-MM-RRRR'),to_date('19-11-2025','DD-MM-RRRR'),'$2y$10$sFZvI3IJMJzgbQ5xAtqu.e76eRwBTCZQRLEWzsv4TUYmwC4zu5OT6    ','0');
REM INSERTING into DONASI.LAPORAN
SET DEFINE OFF;
Insert into DONASI.LAPORAN (ID_LAPORAN,ID_CAMPAIGN,ID_PENERIMA,JUDUL_LAPORAN,TANGGAL_GENERATE,TOTAL_DANA_TERKUMPUL,CREATED_AT,UPDATED_AT) values ('5','63','23','membersihkan rayap',to_date('21-11-2025','DD-MM-RRRR'),'2000',to_date('21-11-2025','DD-MM-RRRR'),to_date('21-11-2025','DD-MM-RRRR'));
Insert into DONASI.LAPORAN (ID_LAPORAN,ID_CAMPAIGN,ID_PENERIMA,JUDUL_LAPORAN,TANGGAL_GENERATE,TOTAL_DANA_TERKUMPUL,CREATED_AT,UPDATED_AT) values ('4','63','23','renovasi',to_date('21-11-2025','DD-MM-RRRR'),'10000',to_date('20-11-2025','DD-MM-RRRR'),to_date('21-11-2025','DD-MM-RRRR'));
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index IDX_DONATUR_ACTIVE
--------------------------------------------------------

  CREATE INDEX "DONASI"."IDX_DONATUR_ACTIVE" ON "DONASI"."DONATUR" ("IS_ACTIVE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "DONASI"."DONATUR" MODIFY ("IS_ACTIVE" NOT NULL ENABLE);
--------------------------------------------------------
